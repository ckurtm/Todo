...
//				prefix++;
     ...
     * @throws NoSuchFieldException
     */
    public static <T extends ObjectTable> T getRow(Cursor cursor, Class<T> clazz) throws Exception {
...
//                        LOG.d(tag, "[column: " + col.name() + "]");
     ...
     * @throws NoSuchFieldException
     */
    public static <T extends ObjectTable> List<T> getRows(Cursor cursor, Class<T> clazz) throws Exception {
